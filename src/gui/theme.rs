...
//     fn default() -> Self {
//         Self {
//             defaults_style: Style::new().for_stdout().cyan(),
//             prompt_style: Style::new().for_stdout().bold(),
//             prompt_prefix: style("?".to_string()).for_stdout().yellow(),
//             prompt_suffix: style("›".to_string()).for_stdout().black().bright(),
//             success_prefix: style("✔".to_string()).for_stdout().green(),
//             success_suffix: style("·".to_string()).for_stdout().black().bright(),
//             error_prefix: style("✘".to_string()).for_stdout().red(),
//             error_style: Style::new().for_stdout().red(),
//             hint_style: Style::new().for_stdout().black().bright(),
//             values_style: Style::new().for_stdout().green(),
//             active_item_style: Style::new().for_stdout().cyan(),
//             inactive_item_style: Style::new().for_stdout(),
//             active_item_prefix: style("❯".to_string()).for_stdout().green(),
//             inactive_item_prefix: style(" ".to_string()).for_stdout(),
//             checked_item_prefix: style("✔".to_string()).for_stdout().green(),
//             unchecked_item_prefix: style("✘".to_string()).for_stdout().black(),
//             picked_item_prefix: style("❯".to_string()).for_stdout().green(),
//             unpicked_item_prefix: style(" ".to_string()).for_stdout(),
//             inline_selections: true,
//         }
//     }
// }

// impl Theme for HoardTheme {
    // /// Formats a prompt.
    ...
    //         let st_cursor = self.apply_to(search_term.to_string().chars().nth(cursor_pos).unwrap());
    //         write!(
    //             f,
    //             "{} {}{}{}",
